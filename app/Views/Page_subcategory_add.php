                   ...
                   <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <div class="card-body"><h5 class="card-title">ADD PAGE SUBCATEGORY </h5>   <p>       
                           ...
                           <!---- form --->
<form  class="cmxform" id="Page_subcategory_add" method="POST" action="" autocomplete="off">
...
<div class="col-sm-10">
<td><input name="SubCategoryName" value="" id="SubCategoryName" placeholder="" class="form-control" required=""></td>
...
$("#Page_subcategory_add").on('submit',(function(e) {
...
//debugger;
 ...
 //data.append('Faq_contents', CKEDITOR.instances['Faq_contents'].FAQdetails());
  ...
  $.ajax({
         url: "<?=base_url()?>/MyControl/Page_subcategorydetails",
   type: "POST",
   data:data,
   contentType: false,
         cache: false,
