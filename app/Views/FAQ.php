                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                              ...
                              <?php } ?>
                                ...
                                <a href="<?=base_url()?>/MyControl/FAQ_add" >
                                ...
                                <div class="table-responsive">
                                            <table id="bootstrap-data-table" class="mb-0 table table-bordered">
                                                ...
                                                <td><?php echo $val['Faq_title']?></td>
                                                <td><?php echo $val['Status'] ?></td>
                                            
                                                <td><a href="./FAQ_update?Faq_id=<?php echo $val['Faq_id'] ?>"><i class='fa fa-edit' style="color:blue;"></i></a>
                                                <a onclick="return confirm('are you sure?')" href="./FAQ_delete?Faq_id=<?php echo $val['Faq_id'] ?>"><i class="fa fa-trash-o" style="color:red;"></i></a>  </td>                                              
                                                </tr>
