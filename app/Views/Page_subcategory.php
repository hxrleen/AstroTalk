                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                              ...
                              <?php }  ?>
                                ...
                                <div class="card-body">
                                <h5 class="card-title">PAGE SUBCATEGORY</h5>
                                <a href="<?=base_url()?>/MyControl/Page_subcategory_add" >
                                ...
                                <div class="table-responsive">
                                            <table id="bootstrap-data-table" class="mb-0 table table-bordered">
                                                ...
                                                foreach ($data as $val){?>
                                                <tr>               
                                                <td><?php echo $val['PG_Sub_CAT_ID'] ?> </td>
                                                <td><?php echo $val['Category'] ?></td>
                                                <td><?php echo $val['SubCategoryName'] ?></td>
                                                
                                                <td><a href="./Page_subcategory_update?PG_Sub_CAT_ID=<?php echo $val['PG_Sub_CAT_ID'] ?>"><i class='fa fa-edit' style="color:blue;"></i></a>
                                                <a onclick="return confirm('are you sure?')" href="./Page_subcategory_delete?PG_Sub_CAT_ID=<?php echo $val['PG_Sub_CAT_ID'] ?>"><i class="fa fa-trash-o" style="color:red;"></i></a>  </td>                                              
                                                </tr>
