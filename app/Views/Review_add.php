                ...
                <?php include 'include/Sidebar.php' ?> 
                   <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <div class="card-body"><h5 class="card-title"> ADD Reviews</h5>    <p>       
                              
                       <!---- form --->
<form  class="cmxform" id="Review" method="POST" action="./Review" autocomplete="off">


<div class="position-relative row form-group">
<label for="exampleEmail" class="col-sm-2 col-form-label">Review Date</label>
<div class="col-sm-4">
<td><input type="date" value="" class="form-control form-control-user" id="Review_date" name="Review_date" placeholder="" required=""></td>
</div>
...
<div class="position-relative row form-group">
  ...
  <label for="exampleFile" class="col-sm-2 col-form-label">Comments</label>
                                                <div class="col-sm-10">
                                                <input id="Comments" placeholder="Please Enter the Description" name="Comments" value="" class="form-control ckeditor" type="text" rows="4" cols="50" required=""></input>
                                            ...
                                            <div class="position-relative row form-check" style="align:center">
                                                <div class="col-sm-4 offset-sm-2" >
                                                  <a href="./Review"  ><button class="btn btn-primary">Submit</button></a>
...
//debugger;
 ...
 //data.append('Faq_contents', CKEDITOR.instances['Faq_contents'].FAQdetails());
  ...
  $.ajax({
         url: "<?=base_url()?>/MyControl/Reviewdetails",
   type: "POST",
   data:data,
   contentType: false,
         cache: false,
