                ...
                <?php include 'include/Sidebar.php' ?> 
                   <div class="app-main__outer">
                    <div class="app-main__inner">
                        ...
                        <div class="card-body"><h5 class="card-title">UPDATE PAGE CATEGORY </h5>   <p>       
                              
                          
                           <!---- form --->
<form  class="cmxform" id="Page_Category_update" method="POST" action="" autocomplete="off">

<div class="position-relative row form-group">
<label for="exampleEmail" class="col-sm-2 col-form-label">Page Category ID </label>
<div class="col-sm-10">
<td><input name="PG_CAT_ID" value="<?php echo $data[0]['PG_CAT_ID'] ?>" id="PG_CAT_ID" placeholder="" class="form-control" required=""></td>
...
<div class="col-sm-10">
<td><input name="CategoryName" value="<?php echo $data[0]['CategoryName'] ?>" id="CategoryName" placeholder="" class="form-control" required=""></td>
<small class="form-text text-muted"></small>
</div>
</div>
...
$("#Page_Category_update").on('submit',(function(e) {
...
//debugger;
 ...
 //data.append('Faq_contents', CKEDITOR.instances['Faq_contents'].FAQdetails());
  ...
  $.ajax({
         url: "<?=base_url()?>/MyControl/Page_Category_details",
   type: "POST",
   data:data,
   contentType: false,
         cache: false,
