                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                              ...
                              <?php } ?>
                                ...
                                <a href="<?=base_url()?>/MyControl/User_add" >
                                ...
                                <div class="table-responsive">
                                            <table id="bootstrap-data-table" class="mb-0 table table-bordered">
                                                ...
                                                <td><a href="./User_update?User_id=<?php echo $val['User_id'] ?>"><i class='fa fa-edit' style="color:blue;"></i></a>
                                                <a onclick="return confirm('are you sure?')" href="./User_delete?User_id=<?php echo $val['User_id'] ?>"><i class="fa fa-trash-o" style="color:red;"></i></a></td>                                                                                                                                         
                                                </tr>
