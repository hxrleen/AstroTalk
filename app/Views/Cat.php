                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                              ...
                              <?php } ?>
                                ...
                                <div class="card-body">
                                <h5 class="card-title">Astrologer Categories</h5>
                                <a href="<?=base_url()?>/MyControl/Category_add" >
                                ...
                                <div class="table-responsive">
                                            <table id="bootstrap-data-table" class="mb-0 table table-bordered">
                                                ...
                                                foreach ($data as $val){?>
                                                <tr>               
                                                <td><?php echo $val['Astro_Cat'] ?> </td>
                                                <td><?php echo $val['CatName']?></td>
                                                <td><?php echo $val['Icon'] ?></td>
                                            
                                                <td><a href="./Cat_update?Astro_Cat=<?php echo $val['Astro_Cat'] ?>"><i class='fa fa-edit' style="color:blue;"></i></a>
                                                <a onclick="return confirm('are you sure?')" href="./Cat_delete?Astro_Cat=<?php echo $val['Astro_Cat'] ?>"><i class="fa fa-trash-o" style="color:red;"></i></a>  </td>                                              
                                                </tr>
